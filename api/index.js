...
// const OutboundCollectionName = 'OutboundEmails';
...
//   try {
//     const database = client.db(dbName);
//     const outboundCollection = database.collection(OutboundCollectionName);
//     // const inboundCollection = database.collection(InboundCollectionName);

//     const outboundEmails = await outboundCollection.find(searchQuery).limit(10).toArray();
//     // const inboundEmails = await inboundCollection.find(searchQuery).limit(5).toArray();
//     res.json(outboundEmails);
